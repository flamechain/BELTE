...
internal static partial class StandardLibrary {
    private static NamedTypeSymbol _lazyDirectory;
    private static NamedTypeSymbol _lazyFile;

    internal static NamedTypeSymbol Directory {
        get {
    ...
    internal static NamedTypeSymbol File {
        get {
    ...
    internal static NamedTypeSymbol Console { get; } = StaticClass("Console", [
        StaticClass("Color", [
    ...
    internal static NamedTypeSymbol Math { get; } = StaticClass("Math", [
